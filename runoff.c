...
void tabulate(void)
{
    ...
    /*printf("candidate 1 vote %i\n", candidates[0].votes);
    printf("candidate 2 vote %i\n", candidates[1].votes);
    printf("candidate 3 vote %i\n", candidates[2].votes);
    printf("candidate 4 vote %i\n", candidates[3].votes);*/
    return;
}
...
bool print_winner(void)
{
    ...
    for(int i = 0; i < candidate_count; i++)
    {
        float win_point = (float)voter_count/2;
        if(candidates[i].votes > win_point)
        {
            printf("%s\n", candidates[i].name);
            return(true);
        }
